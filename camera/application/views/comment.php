            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="backend/comment"><i class="icon-font">&#xe004;</i>用户留言</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                            ...
                            <th style="text-align: center">留言与建议</th>
                        </tr>
                        <?php
                        foreach($comments as $comment){
                            ?>
                            <tr>
                                <td style="text-align: center"><?php echo $comment->user->username;?></td>
                                <td style="text-align: center"><?php echo $comment->phone;?></td>
                                <td style="text-align: center"><?php echo $comment->qq;?></td>
                                <td style="text-align: center"><?php echo $comment->email;?></td>
                                <td style="text-align: center"><?php echo $comment->content;?></td>
                            </tr>
                            <?php
                        }
                        ?>
